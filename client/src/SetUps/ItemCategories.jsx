...
class ItemCategories extends Component {
  ...
  handleSubmit = event => {
    ...
    if (this.state.isUpdate) {
      this.UpdateData("/api/ItemCategories/" + this.state.ID, data);
    } else {
      this.postData("/api/ItemCategories", data);
    }
  };
  handleEdit = ItemCategories => {
    const data = {
    ...
    // this.handleRolesOpoup(ItemCategories.Amount);
  };
  handleDelete = k => {
    swal({
  ...
  render() {
    ...
    const Rows = [...this.state.ItemCategories];
        ...
        let Rowdata = {
          ...
          action: (
            <span>
              ...
              &nbsp;
              {this.validaterole("Item categories", "Edit") ? (
                <a
                  className="text-blue"
                  style={{ color: "#007bff" }}
              ...
              &nbsp;
              {this.validaterole("Item categories", "Remove") ? (
                <a
                  className="text-red"
                  style={{ color: "#f44542" }}
            ...
            <div className="row">
              ...
              <div className="col-sm-4">
                <span className="float-right">
                  {this.validaterole("Item categories", "AddNew") ? (
                    <button
                      type="button"
